...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 31, 2017 at 04:07 PM
...
ALTER TABLE `gift_cards`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_company` (`companies_id`),
  ADD KEY `gift_cards_ibfk_1` (`basket_user_id`);

--
-- Indexes for table `gift_card_categories`
--
...
--
ALTER TABLE `gift_cards`
  ADD CONSTRAINT `FK_company` FOREIGN KEY (`companies_id`) REFERENCES `companies` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `gift_cards_ibfk_1` FOREIGN KEY (`basket_user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `gift_card_categories`
--
ALTER TABLE `gift_card_categories`
  ADD CONSTRAINT `gift_card_categories_ibfk_1` FOREIGN KEY (`gift_card_id`) REFERENCES `gift_cards` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `gift_card_categories_ibfk_2` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`);
